<template>
    <aside :class="{ 'is-expanded': is_expanded }" class="flex flex-col w-[calc(2rem+32px)] min-h-[100vh] overflow-hidden p-4 bg-purple-fonce ease-out duration-200">
      ...
      <div class="navigation my-0 -mx-4 z-10">
        <router-link :class="['button border-t border-white', { 'text-purple bg-purple': currentPage === '/backOffice/dashboard' }]" to="/backOffice/dashboard">
            <svg xmlns="http://www.w3.org/2000/svg" class="mt-4 mb-4" width="32" height="32" viewBox="0 0 24 24"><path fill="#ffffff" d="M5 20v-9.15L2.2 13L1 11.4L12 3l4 3.05V4h3v4.35l4 3.05l-1.2 1.6l-2.8-2.15V20h-5v-6h-4v6zm5-9.975h4q0-.8-.6-1.313T12 8.2t-1.4.513t-.6 1.312"/></svg>
        ...
        <router-link :class="['button border-t border-white', { 'text-purple bg-purple': currentPage === '/backOffice/blog' }]" to="/backOffice/blog">
            <svg xmlns="http://www.w3.org/2000/svg" class="mt-4 mb-4" width="32" height="32"  viewBox="0 0 24 24"><g fill="#ffffff" stroke="#888888" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path stroke-miterlimit="5.759" d="M3 3v16a2 2 0 0 0 2 2h16"/><path stroke-miterlimit="5.759" d="m7 14l4-4l4 4l6-6"/><path d="M18 8h3v3"/></g></svg>
      ...
      <router-link :class="['button border-y border-white', { 'text-purple bg-purple': currentPage === '/backOffice/structure' }]" to="/backOffice/structure">
        <svg xmlns="http://www.w3.org/2000/svg" class="mt-4 mb-4" width="32" height="32" viewBox="0 0 24 24"><path fill="#ffffff" d="M6 22q-1.25 0-2.125-.875T3 19V5q0-1.25.875-2.125T6 2h11v16H6q-.425 0-.712.288T5 19t.288.713T6 20h13V4h2v18zm3-6h6V4H9zm-2 0V4H6q-.425 0-.712.288T5 5v11.175q.25-.075.488-.125T6 16zM5 4v12.175z"/></svg>
                <span class="text" :class="{ 'text-purple': currentPage === '/backOffice/structure' }">Logs</span>
      </router-link>
    <router-link :class="['button border-y border-white', { 'text-purple bg-purple': currentPage === '/backOffice/structure' }]" to="/backOffice/structure">
        <svg xmlns="http://www.w3.org/2000/svg" class="mt-4 mb-4" width="32" height="32" viewBox="0 0 24 24"><path fill="#ffffff" d="M5 21q-.825 0-1.412-.587T3 19V5q0-.825.588-1.412T5 3h7v2H5v14h7v2zm11-4l-1.375-1.45l2.55-2.55H9v-2h8.175l-2.55-2.55L16 7l5 5z"/></svg>
                <span class="text" :class="{ 'text-purple': currentPage === '/backOffice/structure' }">Déconnexion</span>
      </router-link>
    </div>
